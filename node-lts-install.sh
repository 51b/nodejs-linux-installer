...
echo "Node Linux Installer by www.github.com/Eybin"
echo "Need Root for installing NodeJS"
sudo sh -c 'echo "Got Root!"'

echo "Get Latest LTS Version Number..."
{
wget --output-document=node-updater.html https://nodejs.org/dist/latest-v4.x/
...
{
wget https://nodejs.org/dist/latest-v4.x/$VER -O $DIR/$VER
} &> /dev/null
